...
from eegnb.stimuli import COLOR_BW

__title__ = "Oddball task with color/black and white stimuli"


def present(subject = 0, session = 0, duration=120, eeg=None, save_fn=None, ver=1):
    n_trials = 2010
    iti = 0.4
    soa = 0.3
    jitter = 0.2
    ...
    if eeg:
        if save_fn is None:  # If no save_fn passed, generate a new unnamed save file
            save_fn = generate_save_fn(eeg.device_name, "color_oddball", "unnamed")
            print(
