...
word_list_file = os.path.join(exp_dir, "ssneuro_studies", "ss_2025", "P300_values.csv")

__title__ = "Memory and Math"
...
def present(duration=120, eeg=None, save_fn=None, subject=0, session=0, ver=1):
    ...
    mywin.flip()
    mywin.flip()
    words = word_lists.iloc[:,ver-1] # version 1 = words, version 2 = math questions
    # shuffle word list
...
def show_instructions(ver):
    ...
    if ver is 1:
        ...
        Stay still, focus on the centre of the screen, and try not to blink. Try to remember the words displayed as you will be asked to recall them after.
    ...
    if ver is 2:
        ...
        Stay still, focus on the centre of the screen, and try not to blink. Try to solve each math equation and remember the answers, as you will be asked to recall them after.
